...
import com.medialink.deco27widgets.service.UpdateWidgetService
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun startJob() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            builder.setPeriodic(SCHEDULE_OF_PERIOD) // 3m
        }
        ...
        Snackbar.make(rootView, "Job Service Started", Snackbar.LENGTH_SHORT).show()
    }
    ...
    private fun stopJob() {
        ...
        val rootView = window.decorView.rootView
        Snackbar.make(rootView, "Job Service Canceled", Snackbar.LENGTH_SHORT).show()
    }
}
